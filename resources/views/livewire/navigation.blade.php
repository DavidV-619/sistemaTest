<nav class="bg-gray-800" x-data="{ open: false }">
        ...
        <a href="/" class="flex-shrink-0 flex items-center"">
          ...
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <a href="{{route('reportes.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{$category->nombre}}</a>
    ...
    <div class="sm:hidden" x-show="open" x-on:click.away="open = false">
      ...
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="{{route('reportes.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{$category->nombre}}</a>
